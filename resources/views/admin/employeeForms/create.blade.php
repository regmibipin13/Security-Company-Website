...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.employeeForm.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.employee-forms.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label class="required"
                        for="additional_message">{{ trans('cruds.employeeForm.fields.additional_message') }}</label>
                    <textarea class="form-control {{ $errors->has('additional_message') ? 'is-invalid' : '' }}" name="additional_message"
                        id="additional_message" required>{{ old('additional_message') }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                        ...
                        <label class="form-check-label"
                            for="approved">{{ trans('cruds.employeeForm.fields.approved') }}</label>
                    </div>
