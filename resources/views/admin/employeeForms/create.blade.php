    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-forms.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('additional_message') ? 'is-invalid' : '' }}" name="additional_message" id="additional_message" required>{{ old('additional_message') }}</textarea>
