                                ...
                                <td>
                                    @can('employee_attendance_show')
                                        <a class="btn btn-xs btn-primary"
                                            href="{{ route('admin.employee-attendances.show', $employeeAttendance->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('employee_attendance_edit')
                                        <a class="btn btn-xs btn-info"
                                            href="{{ route('admin.employee-attendances.edit', $employeeAttendance->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('employee_attendance_delete')
                                        <form
                                            action="{{ route('admin.employee-attendances.destroy', $employeeAttendance->id) }}"
