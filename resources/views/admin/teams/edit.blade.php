            ...
            <form method="POST" action="{{ route('admin.teams.update', [$team->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text"
                        name="father_name" id="father_name" value="{{ old('father_name', $team->father_name) }}" required>
                ...
                <div class="form-group">
                    <label class="required"
                        for="grandfather_name">{{ trans('cruds.team.fields.grandfather_name') }}</label>
                    <input class="form-control {{ $errors->has('grandfather_name') ? 'is-invalid' : '' }}" type="text"
                        name="grandfather_name" id="grandfather_name"
                        value="{{ old('grandfather_name', $team->grandfather_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="text"
                        name="position" id="position" value="{{ old('position', $team->position) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text"
                        name="phone" id="phone" value="{{ old('phone', $team->phone) }}" required>
                    @if ($errors->has('phone'))
                        <div class="invalid-feedback">
                            {{ $errors->first('phone') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                        name="address" id="address" value="{{ old('address', $team->address) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('started_from') ? 'is-invalid' : '' }}" type="date"
                        name="started_from" id="started_from" value="{{ old('started_from', $team->started_from) }}"
                        required>
                ...
                <div class="form-group" id="ended_at_div">
                    ...
                    <input class="form-control {{ $errors->has('ended_at') ? 'is-invalid' : '' }}" type="date"
                        name="ended_at" id="ended_at" value="{{ old('ended_at', $team->ended_at) }}">
                ...
                <div class="form-group" id="is_enabled">
                    <label for="is_enabled">{{ trans('cruds.team.fields.is_enabled') }}</label>
                    <input class="form-check" type="checkbox" name="is_enabled" id="is_enabled"
                        {{ $team->is_enabled ? 'checked' : '' }}>
