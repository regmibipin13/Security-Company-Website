...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.employee_reports.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ url('/admin/reports/' . $employeeReport->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('employee_id') ? 'is-invalid' : '' }}" type="text"
                        name="employee_id" id="employee_id" value="{{ old('employee_id', $employeeReport->employee_id) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}" type="date" name="date"
                        id="date" value="{{ old('date', $employeeReport->date) }}" required>
                    @if ($errors->has('date'))
                        <div class="invalid-feedback">
                            {{ $errors->first('date') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('time') ? 'is-invalid' : '' }}" type="text"
                        name="time" id="time" value="{{ old('time', $employeeReport->time) }}" required>
                    @if ($errors->has('time'))
                        <div class="invalid-feedback">
                            {{ $errors->first('time') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text"
                        name="location" id="location" value="{{ old('location', $employeeReport->location) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text"
                        name="description" id="description" required>{{ old('description', $employeeReport->description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('operation') ? 'is-invalid' : '' }}" type="text"
                        name="operation" id="operation" required>{{ old('operation', $employeeReport->operation) }}</textarea>
