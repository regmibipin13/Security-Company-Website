...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="profession">{{ trans('cruds.testimonial.fields.profession') }}</label>
                <input class="form-control {{ $errors->has('profession') ? 'is-invalid' : '' }}" type="text" name="profession" id="profession" value="{{ old('profession', $testimonial->profession) }}" required>
                @if($errors->has('profession'))
                    <div class="invalid-feedback">
                        {{ $errors->first('profession') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.testimonial.fields.profession_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="review">{{ trans('cruds.testimonial.fields.review') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('review') ? 'is-invalid' : '' }}" name="review" id="review">{!! old('review', $testimonial->review) !!}</textarea>
