    ...
    <div class="container pb-5" style="background: #fff;" id="main-container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <p style="font-weight: 500; line-height:35px; font-size:16px;">This is to certify that Mr./Ms. <strong style="text-decoration: underline;">{{ $team->name }}</strong> has worked as <strong style="text-decoration: underline;">{{ $team->position }}</strong> in our company from <strong style="text-decoration: underline;">{{ $team->started_from }}</strong> to <strong style="text-decoration: underline;">{{ $team->ended_at }}</strong>
