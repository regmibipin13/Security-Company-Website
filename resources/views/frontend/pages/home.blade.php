                ...
                <div
                    ...
                    <div class="flex justify-center mt-5">
                        <a class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
                            href="{{ $website->button_1_link }}">{{ $website->button_1_title }}</a>
                        <a class="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg"
                            href="{{ $website->button_2_link }}">{{ $website->button_2_title }}</a>
                    </div>
                </div>
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img class="object-cover object-center rounded" alt="hero"
                        src="{{ $website->hero_image ? $website->hero_image->getUrl() : '' }}">
                </div>
            </div>
        </section>
        <hr>
                            ...
                            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                ...
                                @else
                                    <img class="lg:h-48 md:h-36 w-full object-cover object-center"
                                        src="{{ $service->feature_media ? $service->feature_media->getUrl() : '' }}"
                                        alt="{{ $service->name }}">
                                @endif
                                <div class="p-6">
                                    ...
                                    <div class="flex items-center flex-wrap ">
                                        <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0"
                                            href="{{ route('frontend.singleService', $service->slug) }}">Learn More
                        ...
                        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                            <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                                <img alt="{{ $team->name }}"
                                    ...
                                    src="{{ $team->image ? $team->image->getUrl() : '' }}">
                                <div class="flex-grow">
    ...
    @if (count($testimonials) > 0)
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-20 mx-auto">
                <h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">Our Customer and Employee
                    Feedback</h1>
                <div class="flex flex-wrap -m-4">
                    @foreach ($testimonials as $testimonial)
                        <div class="p-4 md:w-1/2 w-full">
                            <div class="h-full bg-gray-100 p-8 rounded">
                                ...
                                <p class="leading-relaxed mb-2">{!! $testimonial->description !!}</p>
                                <a class="inline-flex items-center">
                                    ...
                                    <span class="flex-grow flex flex-col">
                                        ...
                                        <span class="title-font font-medium text-gray-900">{{ $testimonial->email }}</span>
                                        @if ($testimonial->is_employee)
                                            <span class="title-font font-medium text-gray-900 mt-3">
                                                <span
                                                    class="bg-green-100 text-green-800 text-xs font-semibold mr-2 py-0.5 rounded dark:bg-green-200 dark:text-green-900">Employee
                                                    Feedback</span>
                                            </span>
                                        @endif
                                    </span>
