            ...
            <div class="w-full mt-4  rounded">
                ...
                <ul id="tabs" class="inline-flex w-full px-1 pt-2 ">
                    <li class="px-4 py-2 -mb-px font-semibold text-gray-800 border-b-2 border-blue-400 rounded-t opacity-50">
                        <a id="default-tab" href="#second">Employee Form</a>
                    </li>
                    <li class="px-4 py-2 font-semibold text-gray-800 rounded-t opacity-50"><a href="#first">Company Form</a>
                    </li>
                    <li class="px-4 py-2 font-semibold text-gray-800 rounded-t opacity-50"><a href="#third">Our
                            Location</a></li>
                    <li class="px-4 py-2 font-semibold text-gray-800 rounded-t opacity-50"><a href="#fourth">Training
                            Form</a></li>
                </ul>
                ...
                <div id="tab-contents">
                            ...
                            <company inline-template>
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="relative mb-4">
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.galleryCollection.fields.files_helper') }}</span>
                                    </div>
                                    <div class="relative mb-4">
                        ...
                        <div class="lg:w-3/3 md:w-2/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                            ...
                            <employee inline-template>
                                <form action="{{ url('/api/v1/contact/employee') }}" method="POST" id="employee"
                                    ...
                                    <div class="relative mb-4">
                                        <label for="address" class="leading-7 text-sm text-gray-600">Father's
                                            Name</label>
                                        <input type="text" id="address" value="{{ old('father_name') }}"
                                            name="father_name"
                                            class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    </div>
                                    <div class="relative mb-4">
                                        <label for="address" class="leading-7 text-sm text-gray-600">Grandfather's
                                            Name</label>
                                        <input type="text" id="address" value="{{ old('grandfather_name') }}"
                                    ...
                                    <div class="relative mb-4">
                                        <label for="message" class="leading-7 text-sm text-gray-600">Additional
                                            Message</label>
                                        <textarea id="message" name="message"
                                            class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ old('message') }}</textarea>
                                    </div>
                                    <button
                                        class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
                    ...
                    <div id="third" class="hidden p-4">
                        <div class="lg:w-3/3 md:w-3/3">
                            ...
                            <div class="mt-5" style="max-width: 100%;">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7031.890629260507!2d83.985137!3d28.208974!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399595a600f6e6b7%3A0xfcdb95504cee8fd1!2sSiddhartha%20Hwy%2C%20Pokhara%2033700%2C%20Nepal!5e0!3m2!1sen!2sus!4v1627612141719!5m2!1sen!2sus"
                    ...
                    <div id="fourth" class="hidden p-4">
                        ...
                        @endif
                        <div class="lg:w-3/3 md:w-2/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                            <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">Trainig Form</h2>
                            <form action="{{ url('/api/v1/contact/training') }}" method="POST" id="employee"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="relative mb-4">
                                    <label for="name" class="leading-7 text-sm text-gray-600">Name</label>
                                ...
                                <div class="relative mb-4">
                                    <label for="address" class="leading-7 text-sm text-gray-600">Type of Training</label>
                                    <input type="text" id="address" value="{{ old('type') }}" name="type"
                                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                <div class="relative mb-4">
                                    <label for="message" class="leading-7 text-sm text-gray-600">Additional
