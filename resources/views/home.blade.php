                                    ...
                                    <div class="card">
                                            ...
                                            <form action="{{ url('/admin') }}" method="GET">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="url"
                                                        class="Paste the url of the page" value="{{ request()->url }}">
                                                </div>
                                        ...
                                        @if (request()->has('url') && request()->url !== '' && request()->url !== null)
                                            <div class="card-body">
                                                ...
                                                <br />
                                                <button class="btn btn-primary" onclick="printDiv('printable');">Print
                                                    QR</button>
                                                <a class="btn btn-primary"
                                                    href="data:image/png;base64, {!! base64_encode(qrCode(request()->url, 'png')) !!} " download>Download
                                                    QR</a>
                                            </div>
                                        @endif
                                    </div>
